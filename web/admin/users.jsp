...
<jsp:useBean id="users" class="Bean.UserBean"/>
${edit}
        ...
        <div class="span9">
            <div class="row-fluid">
                ...
                <table class="table table-striped table-bordered table-condensed">
                    ...
                    <c:forEach items="${users.all}" var="user">
                        <form action="useredit" method="post" id="useredit">
                    <tbody>

                    <tr class="list-users">
                        <td><input type="hidden" value="${user.user_id}" name="user_id"> ${user.user_id}</td>
                        <td><input type="text" value="${user.user_name}" name="user_name"></td>
                        <td><input type="number" value="${user.level}" name="level"></td>
