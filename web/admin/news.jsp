        ...
        <div class="span9">
            <div class="row-fluid">
                <div class="page-header">
                    <h1>News <small>All news</small></h1>
                </div>
                <table class="table table-striped table-bordered table-condensed">
                    ...
                    <c:forEach items="${news.all}" var="temp">
                        <form action="new_info" method="post" id="useredit">
                            <tbody>

                            <tr class="list-users">
                                <td><input type="hidden" value="${temp.news_id}" name="new_id">${temp.news_id}</td>
                                <td>${temp.news_title}</td>
                                <td>${temp.news_date}</td>
               ...
               <a  href="new_info.jsp" class="btn btn-success btn-large" >创建新闻</a>
